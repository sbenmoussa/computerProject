...
public class AddComputer2 {
	...
	public ModelAndView post(ModelMap model, @ModelAttribute ComputerDTO computer){	
		...
		computerService.insert(computer.toDTO(""));
		//}
		//model.addAttribute( "add", acf.getResult());
		return new ModelAndView("redirect:/dashboard");
		//model.getRequestDispatcher( "Dashboard").forward( request, response );
	}
